...
# Configuration
DATA_PATH = "/Users/laura/Desktop/515teampro/data"  # Change this if your dataset is elsewhere
...
# Normalize each feature per sample (mean = 0, std = 1)
...
# Build LSTM model
model = Sequential([
    LSTM(64, input_shape=(SAMPLE_LENGTH, NUM_FEATURES)),
